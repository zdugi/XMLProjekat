...
public class PrimerObavestenje {
	public static void main(String[] argv) throws Exception {
		//todo: read and show real document
				...
				telo.getContent().add(new JAXBElement<TZakon>(new QName("http://ftn.uns.ac.rs/xml_obavestenja", "Zakon"), TZakon.class, zakon));
				telo.getContent().add("tekst kojice stojati izmedju");
				telo.getContent().add(new JAXBElement<Integer>(new QName("http://ftn.uns.ac.rs/xml_obavestenja", "Godina"), Integer.class, 2020));
				//todo: promeniti mozda u datum, dan.mesec?
				telo.getContent().add(new JAXBElement<Integer>(new QName("http://ftn.uns.ac.rs/xml_obavestenja", "Dan"), Integer.class, 31));
				telo.getContent().add(new JAXBElement<Integer>(new QName("http://ftn.uns.ac.rs/xml_obavestenja", "Pocetni_sat"), Integer.class, 8));
				telo.getContent().add("traje do");
				telo.getContent().add(new JAXBElement<Integer>(new QName("http://ftn.uns.ac.rs/xml_obavestenja", "Zavrsni_sat"), Integer.class, 12));
				telo.getContent().add(
						new JAXBElement<TAdresa>(new QName("http://ftn.uns.ac.rs/xml_obavestenja", "Adresa"), TAdresa.class, adresa));
				telo.getContent().add(new JAXBElement<Integer>(new QName("http://ftn.uns.ac.rs/xml_obavestenja", "Kancelarija"), Integer.class, 12));
				telo.getContent().add(new JAXBElement<Double>(new QName("http://ftn.uns.ac.rs/xml_obavestenja", "Suma"), Double.class, 321.21));
		        ...
		        Obavestenje blackmagic = (Obavestenje) unmarshaller.unmarshal(new File("data\\xml\\obavestenje_1.xml"));
