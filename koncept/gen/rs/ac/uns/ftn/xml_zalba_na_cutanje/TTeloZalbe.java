 ...
 *       &lt;sequence>
 *         &lt;element name="ORGAN" type="{http://www.w3.org/2001/XMLSchema}anyType"/>
 *         &lt;element name="Element" type="{http://ftn.uns.ac.rs/xml_zalba_na_cutanje}TRazlozi_zalbe"/>
...
public class TTeloZalbe {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "Element", namespace = "http://ftn.uns.ac.rs/xml_zalba_na_cutanje", type = JAXBElement.class)
    })
    @XmlMixed
